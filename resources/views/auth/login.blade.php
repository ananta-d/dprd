...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('template-admin/assets/css/soft-ui-dashboard.css?v=1.1.0') }}"
        rel="stylesheet" />
...
<body class="">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    ...
                                    <p class="mb-0">Login Khusus Admin dan Staff</p>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                                    style="background-image:url('{{ asset('template-admin/assets/img/curved-images/curved6.jpg') }}')">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('template-admin/assets/js/soft-ui-dashboard.min.js?v=1.1.0') }}"></script>
</body>
