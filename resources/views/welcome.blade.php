        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="d-lg-none ms-auto me-4">
                    <a href="{{ route('login-admin-staff') }}" class="navbar-icon bi-person"></a>
                </div>
                    ...
                    <ul class="navbar-nav ms-lg-5 me-lg-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarLightDropdownMenuLink" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">Halaman</a>
                        ...
                        <form method="get" class="custom-form mt-4 pt-2 mb-lg-0 mb-5" role="search">
                            <div class="input-group input-group-lg">
                                ...
                                <input name="keyword" type="search" class="form-control" id="keyword"
                                    placeholder="Cari laporan berdasarkan nomor tiket atau NIK..." aria-label="Search">
                            ...
                            <a href="#">
                                <div class="d-flex">
                                    <div>
                                        ...
                                        <p class="mb-0">Adukan masalah terkait administrasi desa, pelayanan KTP, dan
                                            surat menyurat.</p>
                                    </div>
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="custom-block-overlay-text d-flex">
                                    <div>
                                        ...
                                        <p class="text-white">Transparansi penggunaan dana desa dan laporan pembangunan
                                            infrastruktur secara terbuka untuk warga.</p>

                                        <a href="{{ route('masyarakat.index') }}"
                                            class="btn custom-btn mt-2 mt-lg-3">Buat Pengaduan</a>
                                    </div>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="music-tab" data-bs-toggle="tab"
                                ...
                                aria-selected="false">Keamanan</button>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="timeline-container">
                            <ul class="vertical-scrollable-timeline" id="vertical-scrollable-timeline">
                                ...
                                <li>
                                    ...
                                    <p class="text-white">Klik tombol Login/Masuk, lalu isi formulir laporan dengan
                                        jelas beserta bukti foto yang relevan.</p>
                                ...
                                <li>
                                    ...
                                    <p class="text-white">Admin akan memeriksa kebenaran laporan Anda dalam waktu
                                        maksimal 1x24 jam sebelum diteruskan ke instansi terkait.</p>
                                ...
                                <li>
                                    ...
                                    <p class="text-white">Instansi terkait akan menanggapi laporan Anda di lapangan.
                                        Anda dapat memantau progresnya di halaman dashboard pribadi.</p>
